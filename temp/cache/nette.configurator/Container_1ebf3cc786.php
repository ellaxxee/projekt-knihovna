<?php
// source: /Applications/MAMP/htdocs/my-nette-project/config/common.neon
// source: /Applications/MAMP/htdocs/my-nette-project/config/services.neon
// source: array
...
class Container_1ebf3cc786 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Users\UsersPresenter' => [2 => ['application.2']],
		'App\Presentation\Book\BookPresenter' => [2 => ['application.3']],
	...
	public function createServiceApplication__2(): App\Presentation\Users\UsersPresenter
	{
	...
	public function createServiceApplication__3(): App\Presentation\Book\BookPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/Applications/MAMP/htdocs/my-nette-project/temp/cache/nette.application/touch',
		));
	...
	public function createServiceAssets__registry(): Nette\Assets\Registry
	{
		...
		$service->addMapper(
			...
			rtrim(Nette\Utils\FileSystem::resolvePath('/Applications/MAMP/htdocs/my-nette-project/www', 'assets'), '\/'),
			[],
			true,
		),
		);
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('/Applications/MAMP/htdocs/my-nette-project/temp/cache/journal.s3db');
	}
	...
	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage(
			'/Applications/MAMP/htdocs/my-nette-project/temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_1ebf3cc786 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/Applications/MAMP/htdocs/my-nette-project/temp/cache/latte');
